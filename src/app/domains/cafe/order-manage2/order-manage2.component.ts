...
@Component({
  selector: 'app-order-manage2',
  templateUrl: './order-manage2.component.html',
  styleUrls: ['./order-manage2.component.scss']
})
export class OrderManage2Component implements OnInit {
  orderForm: FormGroup;
  foods = [];
  arrFoods = [];
  summaryList = [];
